#Big Data Science: Tutorial1
# R tutorial code on regression, crossvalidation, 
# and regularization. The data used in the tutorial are Big Five personality trait # questionnaire scores from 2800 students, including their age, education, and gender. 
...
#
#Our task is to compare the coefficients two different RIDGE model model fits. The first model uses less 
...
### ADDITIONAL TASK "Adding nonlinear predictors"
#
#How much can we improve the model by adding polynomial features? To answer this question, extend the 25 
#features in X with second-order polynomials and interactions (X2 with 350 features). 

#Return a variable "comparison" containing the minimum average Mean-Squared 
